...
in
{
  inherit system nixEffectSource pkgsSource homeManagerSource name nixosConfigurationSource
    podProfileDirPath homeManagerConfigurationSource channelsList
    username userHome
